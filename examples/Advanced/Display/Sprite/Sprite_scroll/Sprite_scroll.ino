...
TFT_eSprite graph1 = TFT_eSprite(&KBX.Lcd); // Sprite object graph1

TFT_eSprite stext1 = TFT_eSprite(&KBX.Lcd); // Sprite object stext1

TFT_eSprite stext2 = TFT_eSprite(&KBX.Lcd); // Sprite object stext2
